...
![Last Commit](https://img.shields.io/github/last-commit/sobhankohanpour/python-mini-projects)
![Issues](https://img.shields.io/github/issues/sobhankohanpour/python-mini-projects)
...
```bash
cd python-mini-projects/Math-Projects
```
